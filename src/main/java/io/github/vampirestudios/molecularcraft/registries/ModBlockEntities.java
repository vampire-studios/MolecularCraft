...
public class ModBlockEntities {
    ...
    public static void init() {
        disassemblerBlockEntityBlockEntityType = Registry.register(Registry.BLOCK_ENTITY,
                "molecularcraft:disassembler", BlockEntityType.Builder.create(DisassemblerBlockEntity::new, ModBlocks.DISASSEMBLER).build(null));
        assemblerBlockEntityBlockEntityType = Registry.register(Registry.BLOCK_ENTITY,
